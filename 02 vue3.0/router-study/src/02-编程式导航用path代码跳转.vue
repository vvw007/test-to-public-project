<template>
  <div class="container">
    ...
    <nav class="top_wrap">
      ...
      <span
        @click="() => $router.push('/find', 'Find')"
        :class="{ 'router-link-active': isActive('/find') }"
        >发现音乐</span
      >
      <span
        @click="() => $router.push('/my', 'My')"
        :class="{ 'router-link-active': isActive('/my') }"
        >我的音乐</span
      >
      <span
        @click="() => $router.push('/part', 'Part')"
        :class="{ 'router-link-active': isActive('/part') }"
        >朋友</span
      >
      <!-- 或按如下写法 -->
      <!--       
